...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItMonkey.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ItMonkey.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ItMonkey.Models.Customer", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("ItMonkey.Models.MessageStore", b =>
                {
                    ...
                    b.Property<string>("ReceiverAvator");

                    b.Property<long>("ReceiverId");

                    b.Property<string>("SenderAvator");
            ...
            modelBuilder.Entity("ItMonkey.Models.Product", b =>
                {
                    ...
                    b.Property<bool>("MonkeyCionDeal");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ItMonkey.Authorization.Roles.Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ItMonkey.Authorization.Users.User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ItMonkey.Authorization.Roles.Role", b =>
                {
                    b.HasOne("ItMonkey.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("ItMonkey.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("ItMonkey.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
