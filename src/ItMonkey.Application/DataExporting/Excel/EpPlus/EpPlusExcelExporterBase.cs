...
using ItMonkey.Dto;
using ItMonkey.Net.MimeTypes;
using OfficeOpenXml;

namespace ItMonkey.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : ItMonkeyAppServiceBase, ITransientDependency
    {
