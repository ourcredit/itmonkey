...
```
  ...
  Configuration.Modules.AbpAutoMapper().Configurators.Add(CustomerJobMapper.CreateMappings);
```
...
```
Configuration.Authorization.Providers.Add<JobAppAuthorizationProvider>();
```
